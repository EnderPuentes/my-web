...
export default function Header({}: Props) {
  return (
    <header className="sticky top-0 border-b bg-background dark:bg-gradient-to-b from-background to-gray-950 z-50 shadow-sm h-20 flex justify-center items-center">
